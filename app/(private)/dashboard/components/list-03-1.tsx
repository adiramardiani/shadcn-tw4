...
const iconStyles = {
  ...
  career: 'bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100',
  education: 'bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100',
  property: 'bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100'
};
...
const ITEMS: ListItem[] = [
  ...
  },
  {
    ...
    subtitle: 'Obtain project management certification',
    icon: Briefcase,
    iconStyle: 'career',
    date: 'Target: Sep 2024',
    status: 'pending',
    progress: 10
  },
  {
    ...
    subtitle: 'Complete online MBA program',
    icon: GraduationCap,
    iconStyle: 'education',
  ...
  },
  {
    ...
    subtitle: 'Increase 401(k) contributions',
    icon: PiggyBank,
    iconStyle: 'savings',
    date: 'Target: Ongoing',
    amount: '$500,000',
  ...
  },
  {
    ...
    subtitle: 'Launch e-commerce store',
    icon: Briefcase,
    iconStyle: 'career',
  ...
  },
  {
    ...
    subtitle: 'Become fluent in Spanish',
    icon: GraduationCap,
    iconStyle: 'education',
    date: 'Target: Dec 2024',
    status: 'in-progress',
...
export default function List031({ items = ITEMS, className }: List03Props) {
  return (
